...
object EntryPanelAssembly {
    ...
    private fun resetTags() {
        ...
        SORTING_TAGS[this.INTEL_OTHER] = true
    }
    ...
    fun assemble(panel: CustomPanelAPI) {
        ...
        val sortingSection = this.createSortingPanel(panel, contentHeight - 91f)
    ...
    fun renderControlSection() {
        ...
        val controlSection = panelInstance?.let { this.createControlSection(it) }
    ...
    private fun createSortingPanel(panel: CustomPanelAPI, height: Float): CustomPanelAPI {
        ...
        val frame = this.addFrameBox(backgroundContainer, height)
        ...
        SORTING_TAGS.forEach { tag ->
            ...
            val buttonWrapper = object : InteractiveButton(tagButton, Type.TAG) {
                ...
                override fun applyEffect() {
                    ...
                    this@EntryPanelAssembly.controlButtonsRedrawQueued = true
                }
                override fun check() {
